...
- URLs checked: 120
- URL checks needing attention: 37
- Listing keyword sets changed: 26
- Source-derived keyword sets changed: 45

## Status

- checked: 143
- checked_no_name_match: 511
- fetch_error: 154
- no_source: 175
...
### Bobcat Pass Wilderness Adventures (Angel Fire, Colfax)

- Status: checked
- Add: agriculture
- Remove: None
- Public page: https://angelfirechamber.org/business/bobcat-pass-wilderness-adventures/
...
- Status: checked
- Add: chamber of commerce, festival, workshop
- Remove: None
...
- https://www.lavetatheaterweb.org: <urlopen error [SSL: UNEXPECTED_EOF_WHILE_READING] EOF occurred in violation of protocol (_ssl.c:1016)>
