...
- Canonical rows: 1490
- Rows with a public source URL: 1315
- Distinct source URLs: 408
- URLs selected this run: 120
- URLs checked: 120
- URL checks needing attention: 42
- Listing keyword sets changed: 21
- Source-derived keyword sets changed: 37

## Status

- checked: 132
- checked_no_name_match: 517
- fetch_error: 159
- no_source: 175
- pending_source_check: 507
...
- Status: checked
- Add: education, outdoor recreation
- Remove: None
...
### The Shuler Theater (Raton, Colfax)

- Status: checked
- Add: festival, live music
- Remove: None
- Public page: http://www.shulertheater.com/
...
- https://anchormotelandcottages.com/: <urlopen error [SSL: TLSV1_ALERT_INTERNAL_ERROR] tlsv1 alert internal error (_ssl.c:1016)>
- https://angelfirechamber.org/business/big-river-raft-trips/: HTTP 404
- https://angelfirechamber.org/business/enchanted-circle-pottery/: HTTP 404
- https://angelfirechamber.org/business/far-flung-adventures/: HTTP 404
- https://angelfirechamber.org/business/j-a-fun-bakery-cafe/: HTTP 404
- https://angelfirechamber.org/business/nuckolls-brewing-company/: HTTP 404
...
- https://www.enchantedcirclepottery.com: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1016)>
