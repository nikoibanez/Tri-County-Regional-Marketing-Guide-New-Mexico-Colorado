...
Generated: 2026-08-03T17:06:58+00:00
...
- Keyword sets proposed for review: 719

## Action Queue

- **HIGH - 6 priority directory candidates:** Confirm each linked listing page before adding it to canonical data.
- **MEDIUM - 719 listing keyword sets proposed for review:** Review additions and removals in the latest keyword-sweep report before merging the keyword index.
- **MEDIUM - 175 canonical rows without a website or source URL:** Enrich high-value entries first; do not invent contact paths.
- **LOW - 105 low-confidence text candidates:** Review only after the linked priority queue; do not publish from page text alone.
