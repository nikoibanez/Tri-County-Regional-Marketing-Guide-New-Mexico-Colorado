...
Generated: 2026-07-26T07:09:06+00:00
...
- Internal links: pass
- Source URLs checked: 120
- Source URLs needing attention: 21
- Deep-watch pages checked: 32
- Deep-watch pages failed: 0
- Priority new leads: 12
- Keyword source URLs checked: 120
- Keyword sets proposed for review: 26

## Action Queue

- **HIGH - 21 monitored sources needing attention:** Open the latest source-audit report and confirm failures in a normal browser.
...
- **MEDIUM - 26 listing keyword sets proposed for review:** Review additions and removals in the latest keyword-sweep report before merging the keyword index.
- **LOW - 127 low-confidence text candidates:** Review only after the linked priority queue; do not publish from page text alone.
- **LOW - 37 keyword source pages needing attention:** Open failed pages normally before removing retained source-derived keywords.
