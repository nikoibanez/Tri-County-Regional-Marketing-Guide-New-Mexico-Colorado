...
# These animation palettes use colors observed on the current official websites
# for the City of Raton, Explore Raton, and GrowRaton.
...
VARIANTS = [
    ...
    {
        **BASE,
        "file": "hero-grow-opportunity.svg",
        "brand": "grow-raton",
        "title": "Animated high plains opportunity routes and yucca flowers",
        "desc": "A soft animated high plains scene with connected ridges, open valleys, yucca flowers, and wind lines for funding and practical tools pages.",
        "far": '<path d="M0 430l140-70 142 36 174-102 144 92 142-62 156 96 138-72 152 84 196-116 176 120v284H0z" fill="url(#farTone)" opacity="0.56"/>',
        "mid": '<path d="M0 500c190-74 356-84 516-30 155 52 282 42 424-28 170-84 348-78 660 52v226H0z" fill="url(#nearTone)" opacity="0.52"/>',
        "feature": '<path d="M260 596c168-70 324-78 468-22 128 50 258 46 390-12 136-60 272-56 408 10" fill="none" stroke="#dd8500" stroke-width="18" stroke-linecap="round" opacity="0.30"/><path d="M318 584c142-42 276-36 402 18 124 52 254 48 390-14 120-54 244-48 372 18" fill="none" stroke="#043e00" stroke-width="5" stroke-linecap="round" stroke-dasharray="18 20" opacity="0.24"/>',
    },
    {
        **BASE,
