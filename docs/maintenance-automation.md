...
| Regional and national funding watch | Tuesday at 15:30 UTC | Runs separate economic-development, education, healthcare, nonprofit, and arts-and-culture sweeps across the subject-tagged source registry; compares each page with its last successful fingerprint and extracts possible deadline, eligibility, fee, award, fiscal-sponsor, and allowed-use language | Opens a draft review pull request; never edits public opportunities |
